...
string version = "v36_Summer23MG_test";
...
void DijetHistosCombine() {
  ...
  DijetHistosCombines("/media/storage/nestorma/dijet/rootfiles/v36_Summer23MG_test/jmenano_mc_out_Summer23MG_test_"+version+".root");
